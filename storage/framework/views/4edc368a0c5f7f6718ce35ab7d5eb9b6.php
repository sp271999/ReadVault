                    ...
                    <tbody class="divide-y">
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4"><?php echo e($role->id); ?></td>
                                <td class="px-6 py-4 font-medium"><?php echo e($role->name); ?></td>
                                <td class="px-6 py-4"><?php echo e($role->guard_name); ?></td>
                                <td class="px-6 py-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ReadVault\resources\views/admin/index.blade.php ENDPATH**/ ?>